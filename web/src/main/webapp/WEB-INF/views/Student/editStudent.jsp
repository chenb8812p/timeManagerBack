...
<div class="continer clearfix">
  ...
  <div class="content">
    ...
    <form class="block_form" action="${website}Student/editStudent?id=${student.id}" method="post" >
      <div class="block clearfix">
        <div class="control_area">

          <div class="block">

            学号 <input type="text" name="stuNum" value="${student.stuNum}"><br><br>
            姓名<input type="text" name="stuName" value="${student.stuName}"><br><br>
            学院<input type="text" name="stuInstitute" value="${student.stuInstitute}"><br><br>
            班级<input type="text" name="stuClass" value="${student.stuClass}"><br><br>
